  ...
  const [selectedProductId, setSelectedProductId] = useState(null);
    ...
    return(
        ...
        <div className='productnavbardata'>
          ...
          <a href="#" className="imgecontain">Electronics</a>
          <div className="dropdown">
            <div className="dropdown-column">
              <h3>Office Automation Products</h3>
        ...
        <div>
          ...
          <div className="dropdown">
            <div className="dropdown-column">
              <h3>Medical Laboratory Instruments</h3>
              ...
              {section.prod.map((produc) => (
                <div className="product" key={produc.id}>
                  ...
                  <div className="product-details">
                    <h3 className="product-title">{produc.title}</h3>
